...
func TestPython(t *testing.T) {
	...
	fs := []string{
		...
		testdataPath + "python-x64/3.13.14/libpython3.13.so.1.0",
		testdataPath + "python-x64/3.14.6/libpython3.14.so.1.0",
		...
		testdataPath + "python-arm64/3.13.14/libpython3.13.so.1.0",
		testdataPath + "python-arm64/3.14.6/libpython3.14.so.1.0",
